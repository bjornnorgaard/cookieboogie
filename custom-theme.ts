...
export const customTheme: CustomThemeConfig = {
    ...
    properties: {
        ...
        // =~= Theme Colors  =~=
        // primary | #f5c30f
        "--color-primary-50": "254 246 219", // #fef6db
        "--color-primary-100": "253 243 207", // #fdf3cf
        "--color-primary-200": "253 240 195", // #fdf0c3
        "--color-primary-300": "251 231 159", // #fbe79f
        "--color-primary-400": "248 213 87", // #f8d557
        "--color-primary-500": "245 195 15", // #f5c30f
        "--color-primary-600": "221 176 14", // #ddb00e
        "--color-primary-700": "184 146 11", // #b8920b
        "--color-primary-800": "147 117 9", // #937509
        "--color-primary-900": "120 96 7", // #786007
        // secondary | #4F46E5
